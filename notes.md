...
Probably want an endpoint that searches countries via City for the user to pick one easier

19/07/2026

- Removed state - countries api doesn't provide state. Could try a different api another time
